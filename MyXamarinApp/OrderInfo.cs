...
namespace MyXamarinApp
{
    class OrderInfo : INotifyPropertyChanged
    {
        ...
        {
            get { return freight; }
            set { this.freight = value; RaisePropertyChanged("Freight"); }
        }
        ...
        public OrderInfo(int? orderId, string customerId, int frieght, string country, string customer, string shipCity,bool isChecked)
        {
